...
dsx <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/Demand Planning/Demand Planning Team/BI Forecast Backup/2022/DSX Forecast Backup - 2022.10.03.xlsx")
...
# BoM RM to sku ----
rm_to_sku <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 11.02.22.xlsx", 
                        sheet = "RM to SKU")
...
# BoM Report ----
bom <- read_excel("S:/Supply Chain Projects/LOGISTICS/SCP/Cost Saving Reporting/Inventory Days On Hand/Raw Material Inventory Health (IQR) - 11.02.22.xlsx", 
                  sheet = "BoM")
...
## open orders ----
open_order <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/Oct.2022 Report/Open Orders - 1 Month (14).xlsx")
...
## sku_actual ----
sku_actual <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/Oct.2022 Report/Order and Shipped History (6).xlsx")
...
sales_orders <- read_excel("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Oil Consumption/Oct.2022 Report/Order and Shipped History (7).xlsx")
...
colnames(component_consumption_comparison_final)[13] <- "UoM"
colnames(component_consumption_comparison_final)[14] <- "Adjusted Forecast Cases"
colnames(component_consumption_comparison_final)[15] <- "Forecasted Oil Qty"
colnames(component_consumption_comparison_final)[16] <- "Open Order Cases"
colnames(component_consumption_comparison_final)[17] <- "Actual Shipped Cases"
colnames(component_consumption_comparison_final)[18] <- "Open Order Cases + Actual Shipped Cases"
